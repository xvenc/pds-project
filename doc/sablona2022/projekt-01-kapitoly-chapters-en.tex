...
Then this dictionary is then used in the \textbf{Preprocess} class to create the event count matrix. 
The event count matrix is created by counting the number of occurences of each event for each block ID.
